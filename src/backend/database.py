...
initial_announcements = [
    {
        "title": "Early Registration Window",
        "message": "Families who register before Friday get priority club placement.",
        "starts_at": _utc_iso(_now_utc - timedelta(days=1)),
        "expires_at": _utc_iso(_now_utc + timedelta(days=21)),
        "created_at": _utc_iso(_now_utc),
        "updated_at": _utc_iso(_now_utc)
    }
]
